const wrapper = document.querySelector(".Clima"),
...
function weatherDetails(info){
    if(info.cod == "404"){
        ...
        if(id == 800){
            wIcon.src = "assets/imagenes/iconos/clear.png";
        }else if(id >= 200 && id <= 232){
            wIcon.src = "assets/imagenes/iconos/dia-nublado.png";  
        }else if(id >= 600 && id <= 622){
            wIcon.src = "assets/imagenes/iconos/nieve.png";
        }else if(id >= 701 && id <= 781){
            wIcon.src = "assets/imagenes/iconos/lluvia.png";
        }else if(id >= 801 && id <= 804){
            wIcon.src = "assets/imagenes/iconos/viento.png";
...
function alerta() 
{
alert("A la brevedad nos pondremos en contacto")
}
